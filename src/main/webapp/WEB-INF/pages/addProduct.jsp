                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="date" class="form-control" placeholder="Product Expiry Date *" value="" name="productexpirydate"/>
                                        </div>
                                       
                                    </div>
                                    <div class="col-md-6">
                                        
                                        <input type="submit" class="btnRegister"  value="ADD PRODUCT" formaction="addproduct" formmethod="post" />
                                    </div>
                                </div>
                            </div>
